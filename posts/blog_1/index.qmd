...
tSNE_plot_actual <- data_with_cluster_label %>%
  ...
  scale_shape_manual(values=c(16, 5, 5, 13, 8, 15, 16, 15, 10, 17, 24, 25, 17, 17)) + ggtitle("tSNE plot by author") + xlab("t-SNE X dimension") + ylab("t-SNE Y dimension") 
```
...
tSNE_df_plot <- tSNE_df %>%
  ...
  scale_shape_manual(values=c(16, 5, 5, 13, 8, 15, 16, 15, 10, 17, 24, 25, 17, 17)) +  ggtitle("tSNE plot by us") + xlab("t-SNE X dimension") + ylab("t-SNE Y dimension") +
